...
class laserMapping : public rclcpp::Node {
 public:
  ...
  struct SensorData {
    pcl::PointCloud<PointType>::Ptr
        laserCloudCornerLast;  // not used in optimization
 ...
 public:
  ...
  void preprocessDualLidarFeatures(Transformd current_pose,
                                   SensorType sensor_type);

  void adjustVoxelSize();

  void mappingOptimization(Eigen::Vector3i &postion_in_locamap,
                           Transformd start_tf, tf2::Quaternion roll_pitch_quat,
                           const int laserCloudCornerStackNum,
                           const int laserCloudSurfStackNum);

  void publishTopic(Eigen::Vector3i postion_in_locamap);

  void laserFeatureInfoHandler(
      const super_odometry_msgs::msg::LaserFeature::SharedPtr msgIn);

  void laserCloudRawDataHandler(
      const sensor_msgs::msg::PointCloud2::SharedPtr laserCloudRawdata);
  ...
  void getOdometryFromTimestamp(
      MapRingBuffer<nav_msgs::msg::Odometry::SharedPtr> &buf,
      const double &timestamp, Eigen::Vector3d &T, Eigen::Quaterniond &Q);

  void extractRelativeTransform(
      MapRingBuffer<nav_msgs::msg::Odometry::SharedPtr> &buf,
      Transformd &T_pre_cur, bool imu_prediction);
 ...
 private:
  ...
  rclcpp::Subscription<sensor_msgs::msg::PointCloud2>::SharedPtr
      subLaserCloudCornerLast;
  rclcpp::Subscription<sensor_msgs::msg::PointCloud2>::SharedPtr
      subLaserCloudSurfLast;
  ...
  rclcpp::Subscription<sensor_msgs::msg::PointCloud2>::SharedPtr
      subLaserRawdata;
  rclcpp::Subscription<super_odometry_msgs::msg::LaserFeature>::SharedPtr
      subLaserFeatureInfo;
  ...
  rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr
      pubLaserCloudFullRes_rot;
  rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr
      pubLaserCloudFullResOusterWithFeatures;
  rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr
      pubLaserCloudFullResOuster;
  rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr
      pubLaserCloudFullResHesaiWithFeatures;
  rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr
      pubLaserCloudFullResHesai;
  rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr
      pubLaserCloudRawRes;
  ...
  rclcpp::Publisher<super_odometry_msgs::msg::OptimizationStats>::SharedPtr
  ...
  pcl::PointCloud<pcl::PointXYZHSV>::Ptr hesaiLaserCloudRawWithFeatures;
